...
import java.net.Socket;
    ...
    public class ConnectionHandler implements Runnable  {
       ...
       private static final String homeURL= "C:\\Users\\khate\\Desktop\\WebServer\\src\\dashboard\\dashboard.html";
    ...
    //				*/
                    if(request.getMethod().equals("GET"))
                    {
                        if(request.getResource().equals("/"))//the root doesnt do anything rn. Just a "welcome page"
                        {
                            ...
                            response.sendResponse("200 OK","C:\\Users\\khate\\Desktop\\WebServer\\src\\dashboard\\dashboard.css");
                            
                        }
                        else if (request.getResource().equals("/dashboard.js")) {
                            
                          
                            response.sendResponse("200 OK","C:\\Users\\khate\\Desktop\\WebServer\\src\\dashboard\\dashboard.js");
