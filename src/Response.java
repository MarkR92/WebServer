...
public class Response {
    ...
    // // <p>Check out <a href="https://www.freecodecamp.org/" target="_blank"
    // rel="noopener noreferrer">freeCodeCamp</a>.</p>
    // output.write(("<a href="+ref+">"+ref+"</a>"+"<button
    // style='font-size:20px;'class='delete'
    // onclick='test("+port+")'>x</button>").getBytes());//blank line
    // //output.write(("<a href="+ref+"target="+target+"
    // rel="+rel+">"+ref+"</a>"+"<button style='font-size:20px;'class='delete'
    // onclick='test("+port+")'>x</button>").getBytes());//blank line

    // // output.write(("<a href="+ref+" target=_blank></a>"+"<button
    // style='font-size:20px;'class='delete'
    // onclick='test("+port+")'>x</button>").getBytes());//blank line
    // output.write(("\r\n").getBytes());//blank line
    // }
    ...
    public void sendResponse(String responseCode, ArrayList<Integer> portList) {
        ...
        try {
            ...
            for (Integer port : portList) {
                ...
                // <p>Check out <a href="https://www.freecodecamp.org/" target="_blank"
                // rel="noopener noreferrer">freeCodeCamp</a>.</p>
                output.write(("<div class='selectPort' onclick='select(" + port + ")' id='" + port + "'>" +
                        "<h4>Port: " + port + "</h4>" +
    ...
    // FileReader("C:\\Users\\Robert\\Documents\\CS335\\Java\\WebServer\\src\\upload.html")))
    // {
    // String htmlLine;
    // while((htmlLine = reader.readLine()) != null)
    // {
